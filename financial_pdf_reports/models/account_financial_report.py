...
class AccountingReportBi(models.TransientModel):
    ...
    def check_report(self):
        ...
        return self.env.ref('financial_pdf_reports.action_report_balancesheet').report_action(self, data=final_dict)
    ...
    def check_report_profit(self):
        ...
        return self.env.ref('financial_pdf_reports.action_report_profit_loss').report_action(self, data=final_dict)
    ...
    def print_trial_balance(self):
        ...
        return self.env.ref('financial_pdf_reports.action_report_trial_balance').report_action(self, data=final_dict)
    ...
    def print_general_ledger(self):
        ...
        return self.env.ref('financial_pdf_reports.action_report_general_ledger').report_action(self, data=final_dict)
